 ...
 */
 ...
 //Disable development specific feature like hot reloading before running tests, hence set the env to test.
...
// Test react compontents (virtual dom) without using a browser.
var jsdom = require('jsdom').jsdom;

var exposedProperties = ['window', 'navigator', 'document'];

// Simulate browser using these properties. React relies on these.
